        ...
        <tbody>
          {results.map((r, i) => (
            ...
            >
              ...
              <td className="px-4 py-3">
                {r.eligible ? (
                  <span className="text-green-700 font-medium text-xs bg-green-100 px-2 py-1 rounded-full">
                    Eligible
                  </span>
                ) : (
                  <span
                    className="text-red-700 text-xs bg-red-50 px-2 py-1 rounded-full"
                    title={r.ineligibilityReason}
                  >
